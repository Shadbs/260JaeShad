...
public class MainMenuFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Open Bag");

        jLabel2.setText("Select Location");

        jLabel3.setText("Open Planner");

        jLabel4.setText("Save Game");

        jLabel5.setText("Exit game");

        jLabel6.setText("Make a Selection");
...
this.dispose();        // TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        PlannerFrame plannerFrame = new PlannerFrame();
//        mainMenuFrame.getJlPayerName().setText(playerName);
